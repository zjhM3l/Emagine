...
import com.demo.opencv.EditName;
import com.demo.opencv.R;
import com.demo.opencv.UserSelfInfo;
...
public class TitleLayout extends LinearLayout {
    ...
    public TitleLayout(Context context, AttributeSet attrs) {
        ...
        if(ActivityCollector.getCurrentActivity().getClass().equals(UserSelfInfo.class)){
        ...
        //If you click back, the activity ends
